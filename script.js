...
(function () {
  ...
  var ES = {
    ...
    'hero.lede': 'Soy Ingeniero de Software y Tech Lead — lideré más recientemente ViiBE, la plataforma white-label de quote-to-cash de Viirtue, integrado día a día con el equipo de ingeniería — desde un motor de facturación que procesa cerca de US$1M en ingresos recurrentes mensuales hasta la facturación por consumo de agentes de voz con IA. Me apasiona convertir problemas complejos en productos que la gente realmente disfruta usar, definir el proceso que nos lleva ahí, y ayudar a crecer a los equipos.',
    'hero.cv': 'Descargar CV',

    'about.eyebrow': 'Perfil',
    'about.title': 'Resumen',
    'about.body': 'Ingeniero de software full-stack con más de 9 años construyendo aplicaciones web escalables y mantenibles — más recientemente Tech Lead de ViiBE, la plataforma white-label de quote-to-cash de Viirtue, y uno de los principales contribuidores de su base de código de más de 40 microservicios. Reconstruí el motor de facturación que hoy procesa <strong>cerca de US$1M en ingresos recurrentes mensuales</strong> en <strong>más de 3.000 cuentas</strong>, contribuyendo a una <strong>Serie A de US$10M</strong>. Amplia experiencia en .NET, Angular y Node.js: diseño de sistemas de facturación, cotización, impuestos y pagos, integración de servicios de terceros y de IA, y operación de microservicios event-driven y cloud-native en GCP (GKE / Kubernetes). Lideré la entrega diaria y la mentoría de un equipo multifuncional de hasta 12 personas, trabajando AI-first con herramientas agénticas como Claude Code en todo el ciclo de desarrollo. También me encargué del lado de producto de la entrega — definiendo requerimientos, proceso y disciplina de calidad para el equipo, y evolucionando ese proceso con la llegada de los flujos de trabajo agénticos con IA — manteniéndome integrado y con trabajo práctico en vez de gestionar a distancia. Apasionado por la arquitectura limpia, TDD y el aprendizaje continuo.',
    'about.strengths': 'Facturación, pagos y quote-to-cash · Microservicios event-driven y sagas · Operación cloud-native (GCP · GKE) · Integraciones de terceros y de IA · Ingeniería asistida por IA · Propiedad del proceso de producto y entrega · Liderazgo y mentoría de equipos · Resolución de problemas de cara al cliente · TDD y arquitectura limpia',

    'exp.eyebrow': 'Experiencia',
    'exp.title': 'Trayectoria',
    'exp.viirtue.role': 'Ingeniero de Software / Tech Lead',
    'exp.viirtue.date': 'Ene 2022 — Jul 2026',
    'exp.viirtue.context': 'Plataforma white-label de UCaaS y comunicaciones en la nube para partners MSP y revendedores',
    'exp.tl.date': 'Nov 2023 — Jul 2026',
    'exp.tl.b1': 'Lideré un equipo de desarrollo multifuncional de <strong>hasta 12 ingenieros</strong> — integrándome directamente con ellos como colaborador práctico en vez de gestionar a distancia — coordinando con áreas de toda la organización para entregar funcionalidades de forma efectiva en ViiBE, la plataforma white-label de quote-to-cash de Viirtue, hoy adoptada por <strong>más de 180 partners (~65% de la base)</strong>.',
    'exp.tl.b2': 'Definí y evolucioné el proceso de entrega y la disciplina de ingeniería del equipo — definición de requerimientos, planificación de sprints, estándares de code review y controles de calidad — primero para el desarrollo tradicional, y luego rediseñando ese proceso para flujos de trabajo agénticos asistidos por IA (Claude Code) a medida que la herramienta maduraba, manteniendo la calidad y previsibilidad altas durante la transición.',
    'exp.tl.b3': '<strong>Diseñé y entregué end-to-end la línea de producto de agentes de voz con IA</strong> — cotización, medición de uso por llamada, cálculo de costos y facturación automática de las llamadas con IA — abriendo una nueva fuente de ingresos basada en consumo.',
    'exp.tl.b4': 'Refactoricé todo el sistema de reportes hacia una solución más robusta, estandarizada y funcional, mejorando la confiabilidad y consistencia de los reportes de ingresos, consumo y cuentas por cobrar.',
    'exp.tl.b5': 'Trabajé directamente con clientes para resolver problemas complejos y específicos de cada cuenta, diseñando soluciones a medida y mejorando la satisfacción del cliente.',
    'exp.tl.b6': 'Mentoreé a compañeros mediante pair programming e intercambio de conocimiento, fomentando un ambiente colaborativo donde el equipo aprende en conjunto.',
    'exp.se.role': 'Ingeniero de Software',
    'exp.se.date': 'Ene 2022 — Nov 2023',
    'exp.se.b1': 'Construí un portal para clientes finales que les permite seguir sus facturas y pagos en tiempo real, integrando Stripe y Authorize.Net mediante procesamiento de pagos event-driven basado en sagas (MassTransit / RabbitMQ) y reduciendo las consultas de soporte de facturación.',
    'exp.se.b2': '<strong>Reconstruí el sistema de facturación desde cero</strong>, mejorando la confiabilidad y precisión de la facturación automática recurrente y por consumo — hoy procesando la facturación mensual de <strong>más de 3.000 cuentas</strong> y <strong>cerca de US$1M en ingresos recurrentes mensuales</strong>.',
    ...
    'exp.se.b6': 'Mantuve y operé una flota de más de 40 microservicios cloud-native en .NET y Angular sobre GCP, containerizados y desplegados en Kubernetes (GKE) con Helm e Istio mediante un pipeline de CI/CD GitOps, dentro de un monorepo Nx aplicando TDD.',
    'exp.inamika.role': 'Ingeniero de Software',
    'exp.inamika.date': 'Mar 2020 — Dic 2021',
    'exp.inamika.context': 'Agencia de productos digitales',
    ...
    'exp.wb.context': 'Empresa de desarrollo de software a medida',
    ...
    'tag.process': 'Proceso de entrega y definición de requerimientos',
    'tag.aivoice': 'Agentes de voz con IA',
    'tag.taxengines': 'Motores de impuestos (CSI / SureTax)',
    'tag.designpatterns': 'Patrones de diseño',
    'tag.microservices': 'Microservicios event-driven',
    'tag.sagas': 'Orquestación de sagas',
    'tag.flags': 'Feature flags',
    'tag.agentic': 'Workflows agénticos',
    'tag.aisdlc': 'SDLC asistido por IA',
